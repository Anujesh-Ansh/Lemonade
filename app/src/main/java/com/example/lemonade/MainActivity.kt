...
import com.example.lemonade.R.string
...
class MainActivity : AppCompatActivity() {
    ...
    private fun setViewElements() {
        ...
        lemonImage?.setImageResource(imageAction)
